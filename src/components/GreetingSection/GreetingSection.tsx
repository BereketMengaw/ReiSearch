...
const GreetingSection: React.FC = () => {
  ...
  return (
    <section className="w-full max-w-3xl ml-0 md:ml-[272px] mt-4 md:mt-10 grid grid-cols-1 md:grid-cols-3 grid-rows-1 md:grid-rows-5/2 gap-3 md:gap-6 mb-2 md:mb-4 px-0 md:px-0 ">
      ...
      <div className="col-span-1 md:col-span-2 mt-2 md:mt-3 row-span-1 md:row-span-3/2 bg-gray-200 dark:bg-gray-800 rounded-2xl shadow p-3 md:p-6 flex flex-col md:flex-row items-center gap-3 md:gap-6 transition-colors duration-300">
        <div className="flex-1 flex flex-col justify-between h-full w-full text-center md:text-left items-center md:items-start">
          <div className="flex flex-col w-full items-center md:items-start">
            <span className="text-gray-700 dark:text-gray-100 text-center md:text-left md:text-lg font-semibold mt-12 md:mt-2 mb-1">Hey, Bereket</span>
            <span className="text-1xl md:text-2xl font-bold text-gray-900  dark:text-white mb-0.5 mt-2 text-center md:text-left">{progress}%</span>
          </div>
          <div className="w-2/3 md:w-full h-2 rounded-full bg-blue-100 mx-auto md:mx-0">
            <div className="h-2 rounded-full bg-blue-500 transition-all duration-200" style={{ width: `${progress}%` }}></div>
          </div>
          <div className="flex justify-center md:justify-start w-full">
            <button className="flex items-center gap-1 px-2 bg-blue-500 text-white text-xs md:text-sm font-medium rounded-md hover:bg-blue-600 transition shadow w-fit mt-2 md:mt-0 lg:mt-6">
        ...
        <img src={Bereket} alt="Profile" className="w-20 h-20 md:w-28 md:h-28 rounded-xl object-cover hidden md:block" />
      </div>
    ...
    <div className="col-span-1 row-span-1 flex gap-2 md:gap-3 min-w-0 md:min-w-[270px] mt-2 md:mt-4">
      <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-xl shadow flex flex-col items-center justify-center p-2 transition-colors duration-300 group">
        <span className="text-yellow-400 text-base mb-1">
          <svg className="icon-wiggle" width="28" height="28" fill="none" viewBox="0 0 24 24">
      ...
      <div className="flex-1 bg-green-100 dark:bg-green-900 rounded-xl shadow flex flex-col items-center justify-center p-2 transition-colors duration-300 group">
        <span className="text-green-500 text-base mb-1">
          <svg className="icon-wiggle" width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M12 4a6 6 0 0 1 6 6v3.5l1.29 2.58A1 1 0 0 1 18.42 18H5.58a1 1 0 0 1-.87-1.42L6 13.5V10a6 6 0 0 1 6-6Z" fill="#b9fbc0" stroke="#43a047" strokeWidth="2"/><circle cx="12" cy="20" r="2" fill="#43a047"/></svg>
        </span>
    ...
    <div className="col-span-1 md:col-span-2 row-span-1 bg-white dark:bg-gray-800 rounded-xl shadow p-2 md:p-3 flex gap-2 md:gap-3 transition-colors duration-300">
      ...
      <div className="flex-1 bg-purple-200 dark:bg-purple-900 rounded-xl shadow flex flex-col items-center justify-center p-2 md:p-3 min-w-0 md:min-w-[120px] transition-colors duration-300 min-h-[160px] group">
  <span className="text-purple-400 text-lg mb-2">
    <svg className="icon-wiggle" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <span className="text-purple-700 dark:text-purple-200 text-xs font-semibold">Add Property</span>
      ...
      <div className="flex-1 bg-blue-200 dark:bg-blue-900 rounded-xl shadow flex flex-col items-center justify-center p-2 md:p-3 min-w-0 md:min-w-[120px] border border-blue-100 dark:border-blue-900 transition-colors duration-300 relative overflow-hidden min-h-[160px] group">
      ...
      <div className="flex-1 bg-green-200 dark:bg-green-900 rounded-xl shadow flex flex-col items-center justify-center p-2 md:p-3 min-w-0 md:min-w-[120px] transition-colors duration-300 min-h-[160px] group">
        
        
        <span className="text-blue-800 text-lg mb-2">
          <svg className="icon-wiggle" width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
