...
const RecommendationsBox: React.FC = () => (
  <section className="hidden lg:flex bg-white mt-6 lg:mt-14 dark:bg-gray-800 rounded-xl shadow p-3 lg:p-4 w-full lg:w-1/2 max-w-full min-h-[120px] flex-col transition-colors duration-300">
