...
const RecommendationsBox: React.FC = () => (
  <section className="hidden md:flex bg-white mt-6 md:mt-14 dark:bg-gray-800 rounded-xl shadow p-3 md:p-4 w-full md:w-1/2 max-w-full min-h-[120px] flex-col transition-colors duration-300">
