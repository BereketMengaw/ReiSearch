...
const RecommendationsBox: React.FC = () => (
  <section className="hidden lg:flex bg-white mt-14 dark:bg-gray-800 rounded-lg shadow p-3 w-full lg:w-1/5 min-h-[90px] flex-col justify-between transition-colors duration-200">
