...
const PropertySection: React.FC = () => (
  <section className="w-full max-w-7xl ml-[272px] grid grid-cols-3 gap-5 mb-4">
    ...
    <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow p-6 flex flex-col min-h-[320px] transition-colors duration-300">
    ...
    {/* Add New Property */}
    <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow p-6 flex flex-col min-h-[260px] transition-colors duration-300">
      <div className="flex justify-between items-start mb-4">
