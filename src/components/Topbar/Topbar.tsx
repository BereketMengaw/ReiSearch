...
const Topbar: React.FC = () => {
  ...
  return (
    <header className="w-full h-16 sm:h-18 bg-white dark:bg-gray-900 shadow-sm dark:shadow-lg px-2 sm:px-4 flex items-center justify-between rounded-b-lg fixed top-0 left-0 right-0 z-50 transition-colors duration-300">
      ...
      {/* Center: Search Bar */}
      <div className="flex-1 flex justify-center mx-1 sm:mx-2 md:mx-4">
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-6 min-w-fit"> {/* gap-6 instead of gap-8 */}
        {/* Chat bubble icon */}
        ...
        <button className="flex items-center gap-2 pl-2 pr-4 py-1.5 rounded-lg border border-blue-500 bg-white dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-gray-700 transition shadow-sm"> {/* gap-2, pr-4, py-1.5 */}
      ...
      <div className="md:hidden flex items-center">
        <button className="flex items-center justify-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition" onClick={() => setMenuOpen(v => !v)} aria-label="Open menu">
        ...
        {menuOpen && (
          <div
            ref={menuRef}
            className="absolute right-2 top-16 w-64 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out z-30"
